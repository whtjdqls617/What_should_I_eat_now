	...
	return (
		<>
			<View style={{ marginTop: '20%' }}>
				<OptionImageRow add={0} image={opts[index]} qna={qna} selectOption={selectOption} lightEffect={selectStatus}/>
				<OptionTextRow add={0} lightEffect={selectStatus} qna={qna} />
				<OptionImageRow add={3} image={opts[index]} qna={qna} selectOption={selectOption} lightEffect={selectStatus}/>
